...
upstream_commit()
{
	printf '%s\n' '89d9bcb1f19a03ffafa9a93a5f32049b4bfdaa00'
}
...
version()
{
	printf '%s\n' \
		'Wine Staging 4.17' \
		'Copyright (C) 2014-2019 the Wine Staging project authors.' \
		'Copyright (C) 2018-2019 Alistair Leslie-Hughes' \
		'' \
		'Patchset to be applied on upstream Wine:' \
...
if test "$enable_Compiler_Warnings" -eq 1; then
	...
	# Add notice in patchlist about patches
	printf '%s\n'
